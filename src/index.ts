...
export class Module extends BackendJS.Module.Module<Context, Args, Options> implements Context {
    ...
    private readonly closeAllOpenBalanceOrdersCronjob = new CoreJS.Cronjob(() => this.execute("closeAllOpenBalanceOrders", { account: 2 }), { days: 1 }, CoreJS.addLocaleDate({ days: 1, minutes: -1 }));
